# Monitoramento-de-contratos
  Trabalho por enquanto como administrativo e vi a necessidade de automatizar algumas tarefas trabalhosas que tenho aqui, por isso decidi criar uma planilha do excel do proprio google, usando a propria API para gerenciar e emitir alertas de vencimento de contratos de aluguéis via email. É um projeto pessoal que implementei ao meu trabalho com a aprovação do meu gesto. 
...
- Após a emissão do primeiro aviso, ficará marcado em um campo a mensagem dde que o aviso foi enviado com exito, sendo necessário a limpesa deste campo de forma manual (excluíndo o texto) para a emissão dos outros alertas.
